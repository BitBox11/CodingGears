	...
	<div id="wrapper">
		<nav class="navbar navbar-default navbar-cls-top " role="navigation"
			...
			<div
				...
				Last access : 30 May 2014 &nbsp; <a href="login.html"
								...
								<div class="table-responsive">
									...
									<ul class="pagination">
										<c:if test="${pager.prev}">
											<li><a href='review?pageNum=${pager.start -1 }'> << </a></li>
										</c:if>

										<c:forEach begin="${pager.start}" end="${pager.end }"
											var="num">
											<li><a href="review?pageNum=${num}">${num}</a></li>
										</c:forEach>

										<c:if test="${pager.next}">
											<li><a href='review?pageNum=${pager.end +1 }'> >> </a></li>
										</c:if>
